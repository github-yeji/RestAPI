...
<nav class="navbar navbar-expand-xl navbar-dark bg-white" aria-label="Sixth navbar example">
  ...
  <img src="/babbjo/WebContent/images/2.jpg" width="1200" height="500" alt="home사진" style="margin-left:50px; margin-top:20px;"/>
  
			
  <br>
  <img src="/babbjo/WebContent/images/main.jpg" width="1200" height="500" alt="main사진" style="margin-left:50px;"/>
